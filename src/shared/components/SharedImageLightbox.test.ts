/**
 * Tests for SharedImageLightbox component
 *
...
import SharedImageLightbox from './SharedImageLightbox.vue'
...
describe('SharedImageLightbox', () => {
  ...
  describe('overlay and accessibility (Task 2.1)', () => {
    ...
    it('emits update:open with false when close button is clicked', async () => {
      ...
      const { emitted } = render(SharedImageLightbox, {
        props: {
          open: true,
          src: 'blob:test-url',
          alt: 'Test image'
