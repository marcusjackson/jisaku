...
/**
 * SharedHeaderSettingsIcon
 *
 * Settings gear icon for the header navigation.
 * Extracted for reusability and to keep SharedHeader under size limit.
 */
</script>

<template>
  <svg
    class="shared-header-settings-icon"
    fill="currentColor"
    version="1.1"
