/**
 * Tests for SharedToast component
 *
...
import SharedToast from './SharedToast.vue'
...
describe('SharedToast', () => {
  ...
  it('renders warning toast with correct class', () => {
    ...
    const toast = wrapper.find('[data-testid="toast"]')
    expect(toast.classes()).toContain('base-toast-warning')
  })
  ...
  it('renders info toast with correct class', () => {
    ...
    const toast = wrapper.find('[data-testid="toast"]')
    expect(toast.classes()).toContain('base-toast-info')
  })
