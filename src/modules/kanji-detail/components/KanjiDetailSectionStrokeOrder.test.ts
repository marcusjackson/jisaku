/**
 * KanjiDetailSectionStrokeOrder.test.ts
 *
 * Unit tests for KanjiDetailSectionStrokeOrder component.
...
describe('KanjiDetailSectionStrokeOrder', () => {
  describe('rendering', () => {
    it('renders section with title', () => {
      render(KanjiDetailSectionStrokeOrder, {
        props: {
          strokeDiagram: null,
          strokeGif: null
        }
  ...
  describe('events', () => {
    it('emits save:diagram event on save', async () => {
      ...
      const { emitted } = render(KanjiDetailSectionStrokeOrder, {
        props: {
