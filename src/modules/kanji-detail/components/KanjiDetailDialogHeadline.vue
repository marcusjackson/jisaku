 ...
 *
 * Dialog for editing kanji headline fields: character, display text, keywords.
 */
...
import { kanjiHeadlineSchema } from '../schemas/headline-schema'
...
const { handleSubmit, resetForm } = useForm({
  validationSchema: toTypedSchema(kanjiHeadlineSchema),
  initialValues: {
...
<template>
  ...
  >
    <form
      class="kanji-detail-dialog-headline-form"
    ...
    >
      ...
      <div class="kanji-detail-dialog-headline-actions">
        <BaseButton
          type="button"
          variant="secondary"
          @click="handleCancel"
...
<style scoped>
.kanji-detail-dialog-headline-form {
  display: flex;
  flex-direction: column;
  gap: var(--spacing-md);
}

.kanji-detail-dialog-headline-actions {
  display: flex;
