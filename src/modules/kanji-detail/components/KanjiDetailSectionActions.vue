...
<template>
  <section
    class="kanji-detail-section-actions"
    data-testid="kanji-detail-actions"
  >
    <div class="kanji-detail-section-actions-controls">
      <div class="kanji-detail-section-actions-toggle">
        <label
          class="kanji-detail-section-actions-label"
      ...
      <BaseButton
        aria-label="Delete"
        data-testid="delete-kanji-button"
      ...
      >
        ...
        <template v-else>
          <span class="delete-button-text-full">Delete Kanji</span>
...
.kanji-detail-section-actions-controls {
  display: flex;
...
.kanji-detail-section-actions-toggle {
  display: flex;
  align-items: center;
  gap: var(--spacing-sm);
}

.kanji-detail-section-actions-label {
