/**
 * KanjiDetailStrokeOrderEditMode.test.ts
 *
 * Unit tests for KanjiDetailStrokeOrderEditMode component.
...
import KanjiDetailStrokeOrderEditMode from './KanjiDetailStrokeOrderEditMode.vue'
...
describe('KanjiDetailStrokeOrderEditMode', () => {
  describe('rendering', () => {
    it('renders two file inputs with labels', () => {
      render(KanjiDetailStrokeOrderEditMode, {
        props: {
          strokeDiagram: null,
          strokeGif: null
        }
  ...
  describe('events', () => {
    it('emits save event with values when save button clicked', async () => {
      ...
      const { emitted } = render(KanjiDetailStrokeOrderEditMode, {
        props: {
