...
<template>
  <section
    class="component-detail-section-actions"
    data-testid="component-detail-actions"
  >
    <div class="component-detail-section-actions-controls">
      <div class="component-detail-section-actions-toggle">
        <label
          class="component-detail-section-actions-label"
      ...
      >
        ...
        <template v-else>
          <span class="delete-button-text-full">Delete Component</span>
...
.component-detail-section-actions-controls {
  display: flex;
...
.component-detail-section-actions-toggle {
  display: flex;
  align-items: center;
  gap: var(--spacing-sm);
}

.component-detail-section-actions-label {
