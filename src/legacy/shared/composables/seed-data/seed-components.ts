...
export const SEED_COMPONENTS: SeedComponentData[] = [
  ...
  },
  {
    ...
    strokeCount: 4,
    shortMeaning: 'sun',
    searchKeywords: 'ひ, sun radical',
    description: 'Sun/day radical.',
    canBeRadical: true,
    kangxiNumber: 72,
    kangxiMeaning: 'sun',
  ...
  },
  {
    ...
    strokeCount: 4,
    shortMeaning: 'moon',
    searchKeywords: 'つき, moon radical',
    description: 'Moon/month radical. Also body/flesh.',
    canBeRadical: true,
    kangxiNumber: 74,
    kangxiMeaning: 'moon',
    radicalNameJapanese: 'つき'
  },
  {
    character: '人',
    strokeCount: 2,
    shortMeaning: 'person',
    searchKeywords: 'ひと, person',
    description: 'Person radical.',
    canBeRadical: true,
    kangxiNumber: 9,
    kangxiMeaning: 'person',
    radicalNameJapanese: 'ひと'
  },
  {
    character: '子',
    strokeCount: 3,
    shortMeaning: 'child',
    searchKeywords: 'こ, child',
    description: 'Child radical.',
    canBeRadical: true,
    kangxiNumber: 39,
    kangxiMeaning: 'child',
    radicalNameJapanese: 'こ'
  },
  {
    character: '大',
    strokeCount: 3,
    shortMeaning: 'big',
    searchKeywords: 'だい, big',
    description: 'Big/large radical.',
    canBeRadical: true,
    kangxiNumber: 37,
    kangxiMeaning: 'big',
    radicalNameJapanese: 'だい'
  },
  {
    character: '小',
    strokeCount: 3,
    shortMeaning: 'small',
    searchKeywords: 'しょう, small',
    description: 'Small/little radical.',
    canBeRadical: true,
    kangxiNumber: 42,
    kangxiMeaning: 'small',
    radicalNameJapanese: 'しょう'
  },
  {
    character: '生',
    strokeCount: 5,
    shortMeaning: 'life',
    searchKeywords: 'せい, life',
    description: 'Life/birth radical.',
    canBeRadical: true,
    kangxiNumber: 100,
    kangxiMeaning: 'life',
    radicalNameJapanese: 'せい'
  }
]
...
export function seedComponentOccurrences(
  ...
  const links: [string, string][] = [
    ...
    ['森', '木'], // forest contains tree
    ['林', '木'], // woods contains tree
    ['明', '日'], // bright contains sun
    ['明', '月'], // bright contains moon
    ['休', '人'], // rest contains person
    ['休', '木'], // rest contains tree
    ['好', '女'], // like contains woman
    ['好', '子'], // like contains child
    ['安', '女'], // peaceful contains woman
    ['安', '宀'], // peaceful contains roof
    ['学', '子'], // study contains child (as component)
    ['生', '生'], // life/birth (itself as radical)
    ['大', '大'], // big (itself as radical)
    ['小', '小'] // small (itself as radical)
  ]
