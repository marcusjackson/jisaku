...
import { useComponentFormRepository } from '@/legacy/shared/composables/use-component-form-repository'
import { useComponentGroupingRepository } from '@/legacy/shared/composables/use-component-grouping-repository'
...
async function handleDelete() {
  ...
  try {
    ...
    await router.push({ name: 'legacy-component-list' })
  } catch (err) {
    fetchError.value = err instanceof Error ? err : new Error(String(err))
