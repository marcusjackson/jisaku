...
import BaseInlineTextarea from '@/legacy/base/components/BaseInlineTextarea.vue'
import BaseSelect from '@/legacy/base/components/BaseSelect.vue'

import SharedEntitySearch from '@/legacy/shared/components/SharedEntitySearch.vue'
import SharedQuickCreateKanji from '@/legacy/shared/components/SharedQuickCreateKanji.vue'
import { usePositionTypeRepository } from '@/legacy/shared/composables/use-position-type-repository'

import type { SelectOption } from '@/legacy/base/components/BaseSelect.vue'
import type {
  ComponentForm,
  Kanji,
  OccurrenceWithKanji,
        ...
        <div class="component-detail-kanji-list-item-content">
          <div class="component-detail-kanji-list-item-header">
            <RouterLink
              ...
              :to="`/legacy/kanji/${occurrence.kanji.id}`"
            >
...
.component-detail-kanji-list-delete-button {
  display: inline-flex;
  justify-content: center;
  align-items: center;
  width: 32px;
...
.component-detail-kanji-list-delete-button:hover {
  border-color: var(--color-danger);
  background-color: var(--color-danger-subtle);
  color: var(--color-danger);
}

.component-detail-kanji-list-delete-button:focus-visible {
  box-shadow: var(--focus-ring);
  outline: none;
}

.component-detail-kanji-list-radical-control {
  margin-top: 5px;
}
</style>
