 ...
 * In create mode, shows simplified form (character, short meaning, search keywords).
...
import BaseCombobox from '@/legacy/base/components/BaseCombobox.vue'
...
<template>
  <div class="component-form-fields">
    ...
    <div class="component-form-fields-group component-form-fields-group-full">
      <BaseInput
        v-model="character"
