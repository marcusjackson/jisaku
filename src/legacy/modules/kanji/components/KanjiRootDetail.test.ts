...
vi.mock(
  '@/legacy/shared/composables/use-component-occurrence-repository',
  () => ({
...
vi.mock('@/legacy/shared/composables/use-reading-repository', () => ({
...
vi.mock('@/legacy/shared/composables/use-meaning-repository', () => ({
...
vi.mock('@/legacy/shared/composables/use-classification-repository', () => ({
...
vi.mock('@/legacy/shared/composables/use-radical-repository', () => ({
...
vi.mock('@/legacy/shared/composables/use-vocab-kanji-repository', () => ({
...
vi.mock('@/legacy/shared/composables/use-vocabulary-repository', () => ({
