...
import BaseComboboxMulti from '@/legacy/base/components/BaseComboboxMulti.vue'
import BaseFileInput from '@/legacy/base/components/BaseFileInput.vue'
...
const kenteiOptions = [
  ...
  { label: '4級', value: '4' },
  { label: '3級', value: '3' },
  { label: '準2級', value: 'pre2' },
  { label: '2級', value: '2' },
  { label: '準1級', value: 'pre1' },
  { label: '1級', value: '1' }
]
</script>
