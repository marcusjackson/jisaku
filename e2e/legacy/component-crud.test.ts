...
test.describe('Component CRUD Flow', () => {
  test('create component and view detail page', async ({ page }) => {
    ...
    await page.goto('/legacy/components')
    ...
    await expect(page).toHaveURL('/legacy/components/new')
    await expect(
  ...
  test('no edit page route exists', async ({ page }) => {
    ...
    await page.goto('/legacy/components/1/edit')

    // Should show 404 or redirect
    // The app uses a catch-all route that shows NotFoundPage
    await expect(page).toHaveURL('/legacy/components/1/edit')
